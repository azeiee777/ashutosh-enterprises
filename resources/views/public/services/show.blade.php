...
<div class="col-lg-4"><div class="p-4 rounded-4 border animate-on-scroll"><h5 class="mb-3">Need This Service?</h5><p style="color:#64748B;">Contact us to discuss your requirements and get a customized quote.</p><a href="{{ route('contact') }}" class="btn btn-admin-primary w-100 mb-2"><i class="bi bi-envelope"></i> Contact Us</a><a href="tel:+919876543210" class="btn btn-admin-secondary w-100"><i class="bi bi-telephone"></i> Call Now</a></div>
